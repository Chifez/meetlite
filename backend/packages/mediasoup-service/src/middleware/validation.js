 ...
 */
export const validateMediaState = (req, res, next) => {
 ...
 */
export const validateCollaborationMode = (req, res, next) => {
  const { mode } = req.body;
 ...
 */
export const validateWorkflowOperation = (req, res, next) => {
 ...
 */
export const validateWhiteboardUpdate = (req, res, next) => {
