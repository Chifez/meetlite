...
export class OrganizationPlanSyncService {
   ...
   */
  static async syncOrganizationWithOwner(organizationId) {
    try {
      ...
      const ownerPlan = organization.ownerId.plan;
   ...
   */
  static async syncUserOrganizations(userId) {
    try {
   ...
   * Useful for manual sync jobs or migrations
   */
