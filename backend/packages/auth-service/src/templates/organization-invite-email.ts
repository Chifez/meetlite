...
export const getOrganizationInviteEmailTemplate = (data: OrganizationInviteData) => {
  const {
    organizationName,
    inviterName,
    inviterEmail,
  ...
  const content = `
    ...
    <div class="card" style="text-align: center;">
      <div style="font-size: 20px; font-weight: 700; color: #3D5A80; margin-bottom: 8px; letter-spacing: -0.01em;">${organizationName}</div>
      ...
      <ul class="feature-list">
        <li class="feature-item">
          <div style="display: flex;">
            ...
            <div class="feature-content">Join unlimited team meetings</div>
          </div>
        </li>
        <li class="feature-item">
          <div style="display: flex;">
            <div style="color: #3D5A80; margin-right: 12px; font-weight: bold;">✓</div>
            <div class="feature-content">Collaborate with whiteboards and workflows</div>
          </div>
        </li>
        <li class="feature-item">
          <div style="display: flex;">
        ...
        <li class="feature-item" style="margin-bottom: 0;">
          <div style="display: flex;">
            <div style="color: #3D5A80; margin-right: 12px; font-weight: bold;">✓</div>
            <div class="feature-content">Access organization-specific features</div>
          </div>
        </li>
      </ul>
    </div>
