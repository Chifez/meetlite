...
export const getPlanUpgradeEmailTemplate = (userName: string, planType: string, endDate: string | Date | null) => {
  const contentStyles = `
    <style>
      .upgrade-title {
        color: #7c3aed;
  ...
  const content = `
    ...
    <div class="plan-details">
      ...
      <ul>
        ...
        <li><strong>Valid Until:</strong> ${endDate ? new Date(endDate).toLocaleDateString() : 'N/A'}</li>
