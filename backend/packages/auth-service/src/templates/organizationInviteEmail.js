  ...
  return {
    ...
    html: `
      ...
      <head>
        ...
        <title>Join ${organizationName} on MeetLite</title>
        <style>
          body {
            margin: 0;
            padding: 0;
      ...
      <body>
        <div class="email-container">
          ...
          <div class="header-padding">
            ...
            }" alt='MeetLite Logo' style='height: 32px; margin-bottom: 8px; max-width: 100%;' />
            <h2 class="title-size">You're Invited!</h2>
            <p class="subtitle-size">Join ${organizationName} on MeetLite</p>
          </div>
