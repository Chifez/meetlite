...
export interface PaymentValidatedRequest extends AuthenticatedRequest {
  validatedPayment?: {
    planType: string;
    duration: string;
    priceId: string;
 ...
 */
export const validatePlanType = (req: PaymentValidatedRequest, res: Response, next: NextFunction) => {
 ...
 */
export const validateUserOwnership = (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  const user = req.user;
 ...
 */
export const validateSessionId = (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
