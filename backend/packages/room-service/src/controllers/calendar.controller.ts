...
export const handleGoogleCallback = async (req: any, res: Response) => {
  ...
  try {
    ...
    finalEmail = userInfo.data.email || userEmail; // Use Google's email if available
  } catch (emailError) {
...
export const connectGoogleCalendar = async (req: any, res: Response) => {
...
export const importCalendarEvents = async (req: any, res: Response) => {
  ...
  if (calendarType === 'google') {
    ...
    if (response.value && Array.isArray(response.value)) {
      response.value.forEach((event: any) => {
        events.push({
          id: event.id,
          title: event.subject,
...
export const exportMeetingToCalendar = async (req: any, res: Response) => {
...
export const refreshCalendarCache = async (req: any, res: Response) => {
...
export const checkCalendarConflicts = async (req: any, res: Response) => {
  const { startDate, endDate } = req.body;
  const userId = req.user.userId;
...
export const scheduleMeetingOnCalendar = async (req: any, res: Response) => {
  const {
    title,
    description,
    startDate,
...
export const deleteCalendarEvent = async (req: any, res: Response) => {
...
export const getConnectedCalendars = async (req: any, res: Response) => {
  const userId = req.user.userId;
...
// Disconnect calendar
export const disconnectCalendarIntegration = async (req: any, res: Response) => {
  const { calendarType } = req.body;
  const userId = req.user.userId;
