...
export class RoomController {
  ...
  async createRoom(req, res) {
    try {
      ...
      return ResponseHelpers.serverError(res, 'Failed to create room', error);
    }
  }
  ...
  async getRoom(req, res) {
    try {
      ...
      return ResponseHelpers.forbidden(res, 'Access denied to this room');
    } catch (error) {
      console.error('Get room error:', error);
      return ResponseHelpers.serverError(res, 'Failed to get room', error);
    }
  }
